...
$(function(){
	...
	$(document).ready(function(){
		...
		$('.second-back').click(function() {
			$(this).parents('#second-step').find('input').prop('checked', false);
			$(this).parents('#second-step').find('button').addClass('not-active');
		});
		$('.third-back').click(function() {
			$(this).parents('#third-step').find('input').prop('checked', false);
			$(this).parents('#third-step').find('button').addClass('not-active');
		});
		...
		//подгрузка объектов
		$('.s4 .play-video').click(function(){$('#s4video-modal').arcticmodal();});
		...
		// 	$('#photo-sldr-modal-kurtki').arcticmodal({
		// 		beforeOpen: function() {
		// 			$('.for-sect2-slider').slick('slickNext');
		// 			$('.for-sect2-slider').slick('slickPrev');
		// 		}
		// 	});
		// });
		...
		$('.it.garderob, .garderob').click(function() {
			$('#photo-sldr-modal-garderob').arcticmodal({
				...
				afterOpen: function() {
					setTimeout(function() {$('.for-sect2-slider').slick('setPosition');}, 100);
				}
			});
		});
